...
export const FORM_AI_NAMES = {
  ...
  ACTION_GENERATE_FROM_STRATEGY_PROMPT: "generate_from_strategy_prompt",
...
export const REGISTERED_FORM_AI_ACTIONS = [
  ...
  },
  {
    ...
    actions: [
      ...
      {
        action_name: FORM_AI_NAMES.ACTION_GENERATE_FROM_STRATEGY_PROMPT,
        label_fa: "تولید خروجی از پرامپت راهبردی",
        default_button_label_fa: "تولید با پرامپت راهبردی",
      },
    ],
  },
  {
